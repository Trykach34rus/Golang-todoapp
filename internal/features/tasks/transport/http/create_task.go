...
type CreateTaskRequest struct {
	Title string `json:"title" validate:"required,min=1,max=100" example:"Сходить в зал"`
	Description *string `json:"description" validate:"omitempty,min=1,max=1000" example:"Покачать бицуху"`
...
// @Success     201 {object} CreateTaskResponse "Успешное создание задачи"
...
// @Failure     500 {object} core_http_response.ErrorResponse "Internal server 
// @Router      /tasks [post]
